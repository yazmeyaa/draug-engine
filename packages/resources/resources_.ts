...
export type ResourceLoader<T extends object> = (url: string) => T;

export class Resource<TData extends object> {
...
export class ResourceStorage<TData extends object> {
...
export class ResourcesManager {
    ...
    public register<T extends object>(res: ClassType<Resource<T>>, defaultLoader: ResourceLoader<T>): ResourceStorage<T> {
    ...
    public getStorage<T extends object>(res: ClassType<Resource<T>>): ResourceStorage<T> | null {
        return this.storages_.get(res) ?? null;
    }

    public tryGetStorage<T extends object>(res: ClassType<Resource<T>>): ResourceStorage<T> {
